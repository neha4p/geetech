		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4">
					...
					<p><?= ThemeHelper::getThemeSetting(@$theme_settings->footer_description, 'App is your Video Subscription Platform. Add unlimited videos, posts, and pages to your subscription site. Earn re-curring revenue and require users to subscribe to access premium content on your website.') ?></p>
